...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:159
 * @astdecl PrimitiveType : TypeDecl ::= Modifiers <ID:String> BodyDecl*;
 * @production PrimitiveType : {@link TypeDecl};

 */
public class PrimitiveType extends TypeDecl implements Cloneable {
  /**
   * @aspect CreateQualifiedAccesses
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/QualifiedNames.jrag:131
   */
  ...
  /**
   * @aspect SuperClasses
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:717
   */
  ...
  public PrimitiveType(Modifiers p0, String p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   */
  public PrimitiveType(Modifiers p0, beaver.Symbol p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:42
   */
   ...
   * @attribute syn
   * @aspect TypeConversion
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:45
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean narrowingConversionTo(TypeDecl type) {
    ...
    boolean narrowingConversionTo_TypeDecl_value = type.subtype(this);
    if (state().inCircle()) {
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:182
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:237
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:535
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="Subtyping", declaredAt="/Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:535")
  public boolean convertibleToShort() {
    boolean convertibleToShort_value = false;
    return convertibleToShort_value;
  }
  /**
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:539
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean convertibleToInt() {
    boolean convertibleToInt_value = false;
    return convertibleToInt_value;
  }
  /**
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:545
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean convertibleToLong() {
    boolean convertibleToLong_value = false;
    return convertibleToLong_value;
  }
  /**
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:552
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean convertibleToFloat() {
    boolean convertibleToFloat_value = false;
    return convertibleToFloat_value;
  }
  /**
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:560
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean convertibleToDouble() {
    boolean convertibleToDouble_value = false;
    return convertibleToDouble_value;
  }
  /**
   * @attribute syn
   * @aspect Annotations
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/frontend/Annotations.jrag:201
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect AutoBoxing
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/frontend/AutoBoxing.jrag:50
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean strictSubtype(TypeDecl type) {
    ...
    if (!state.inCircle() || state.calledByLazyAttribute()) {
      ...
      do {
        _value.cycle = state.nextCycle();
        new_strictSubtype_TypeDecl_value = type.supertypePrimitiveType(this);
      ...
      _value.cycle = state.cycle();
      boolean new_strictSubtype_TypeDecl_value = type.supertypePrimitiveType(this);
      if (((Boolean)_value.value) != new_strictSubtype_TypeDecl_value) {
        state.setChangeInCycle();
        _value.value = new_strictSubtype_TypeDecl_value;
      }
