 ...
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java8/frontend/BytecodeReader.jrag:35
 */
    ...
    public CompilationUnit parse(TypeDecl outerTypeDecl, String outerClassName, Program program)
      ...
      try {
        ...
        if (major > 52) {
          ...
          warning(String.format("Warning: attempting to parse classfile version %s."
