...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:301
 * @astdecl LEExpr : RelationalExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class LEExpr extends RelationalExpr implements Cloneable {
   ...
   */
  public LEExpr treeCopyNoTransform() {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:487
   */
  ...
  public Constant constant() {
    Constant constant_value = Constant.create(binaryNumericPromotedType().leIsTrue(left(), right()));
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:377
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
