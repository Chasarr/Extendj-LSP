...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:299
 * @astdecl LTExpr : RelationalExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class LTExpr extends RelationalExpr implements Cloneable {
   ...
   */
  public LTExpr treeCopyNoTransform() {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:485
   */
  ...
  public Constant constant() {
    Constant constant_value = Constant.create(binaryNumericPromotedType().ltIsTrue(left(), right()));
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:375
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
