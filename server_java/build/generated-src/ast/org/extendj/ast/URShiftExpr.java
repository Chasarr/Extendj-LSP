...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:287
 * @astdecl URShiftExpr : ShiftExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class URShiftExpr extends ShiftExpr implements Cloneable {
   ...
   */
  public URShiftExpr treeCopyNoTransform() {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:73
   */
  ...
  public Constant constant() {
    Constant constant_value = type().urshift(getLeftOperand().constant(), getRightOperand().constant());
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:369
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
