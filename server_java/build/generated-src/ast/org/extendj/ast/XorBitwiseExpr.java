...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:292
 * @astdecl XorBitwiseExpr : BitwiseExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class XorBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   */
  public XorBitwiseExpr treeCopyNoTransform() {
   ...
   */
  public XorBitwiseExpr treeCopy() {
    XorBitwiseExpr tree = (XorBitwiseExpr) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:79
   */
  ...
  public Constant constant() {
    Constant constant_value = type().xorBitwise(getLeftOperand().constant(), getRightOperand().constant());
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:372
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
