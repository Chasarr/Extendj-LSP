...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:161
 * @astdecl NullType : TypeDecl ::= Modifiers <ID:String> BodyDecl*;
...
public class NullType extends TypeDecl implements Cloneable {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrint.jadd:519
   */
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:219
   */
   ...
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:571
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean strictSubtype(TypeDecl type) {
    ...
    if (!state.inCircle() || state.calledByLazyAttribute()) {
      ...
      do {
        _value.cycle = state.nextCycle();
        new_strictSubtype_TypeDecl_value = type.supertypeNullType(this);
      ...
      _value.cycle = state.cycle();
      boolean new_strictSubtype_TypeDecl_value = type.supertypeNullType(this);
      if (((Boolean)_value.value) != new_strictSubtype_TypeDecl_value) {
        state.setChangeInCycle();
        _value.value = new_strictSubtype_TypeDecl_value;
      }
