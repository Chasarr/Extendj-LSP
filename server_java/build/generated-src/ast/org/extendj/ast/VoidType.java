...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:162
 * @astdecl VoidType : TypeDecl ::= Modifiers <ID:String> BodyDecl*;
...
public class VoidType extends TypeDecl implements Cloneable {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrint.jadd:638
   */
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:80
   */
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:216
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute syn
   * @aspect Subtyping
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:574
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public boolean strictSubtype(TypeDecl type) {
    ...
    if (!state.inCircle() || state.calledByLazyAttribute()) {
      ...
      do {
        _value.cycle = state.nextCycle();
        new_strictSubtype_TypeDecl_value = type.supertypeVoidType(this);
      ...
      _value.cycle = state.cycle();
      boolean new_strictSubtype_TypeDecl_value = type.supertypeVoidType(this);
      if (((Boolean)_value.value) != new_strictSubtype_TypeDecl_value) {
        state.setChangeInCycle();
        _value.value = new_strictSubtype_TypeDecl_value;
      }
