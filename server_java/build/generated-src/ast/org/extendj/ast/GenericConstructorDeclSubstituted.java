...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/grammar/Generics.ast:81
 * @astdecl GenericConstructorDeclSubstituted : GenericConstructorDecl ::= Modifiers <ID:String> Parameter:ParameterDeclaration* Exception:Access* [ParsedConstructorInvocation:Stmt] Block TypeParameter:TypeVariable* <Original:GenericConstructorDecl> ImplicitConstructorInvocation:Stmt;
 ...
 */
public class GenericConstructorDeclSubstituted extends GenericConstructorDecl implements Cloneable {
  /**
   * @declaredat ASTNode:1
   */
  public GenericConstructorDeclSubstituted() {
    super();
  }
  /**
  ...
  public GenericConstructorDeclSubstituted copy() {
    try {
      GenericConstructorDeclSubstituted node = (GenericConstructorDeclSubstituted) clone();
      node.parent = null;
      if (children != null) {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/frontend/MethodSignature.jrag:443
   */
