...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:240
 * @astdecl AssignRShiftExpr : AssignShiftExpr ::= Dest:Expr Source:Expr;
...
public class AssignRShiftExpr extends AssignShiftExpr implements Cloneable {
   ...
   */
  public AssignRShiftExpr treeCopyNoTransform() {
   ...
   */
  public AssignRShiftExpr treeCopy() {
    AssignRShiftExpr tree = (AssignRShiftExpr) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:391
   */
