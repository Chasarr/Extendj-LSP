...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/grammar/Generics.ast:82
 * @astdecl GenericConstructorDeclErased : GenericConstructorDecl ::= Modifiers <ID:String> Parameter:ParameterDeclaration* Exception:Access* [ParsedConstructorInvocation:Stmt] Block TypeParameter:TypeVariable* <Original:GenericConstructorDecl> ImplicitConstructorInvocation:Stmt;
...
public class GenericConstructorDeclErased extends GenericConstructorDecl implements Cloneable {
  ...
  public GenericConstructorDeclErased copy() {
    try {
      GenericConstructorDeclErased node = (GenericConstructorDeclErased) clone();
      node.parent = null;
      if (children != null) {
   ...
   * @apilevel high-level
   */
  public void setOriginal(GenericConstructorDecl value) {
    tokenGenericConstructorDecl_Original = value;
  }
  /** @apilevel internal 
   */
  ...
  public GenericConstructorDecl getOriginal() {
    return tokenGenericConstructorDecl_Original;
  }
  /**
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/frontend/GenericMethods.jrag:105
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
  @ASTNodeAnnotation.Source(aspect="GenericMethods", declaredAt="/Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/frontend/GenericMethods.jrag:105")
