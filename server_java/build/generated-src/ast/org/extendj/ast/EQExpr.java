...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:305
 * @astdecl EQExpr : EqualityExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class EQExpr extends EqualityExpr implements Cloneable {
   ...
   */
  public EQExpr treeCopyNoTransform() {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:481
   */
  ...
  public Constant constant() {
    Constant constant_value = Constant.create(binaryNumericPromotedType().eqIsTrue(left(), right()));
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:379
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/src/jastadd/StringEqCheck.jrag:5
  ...
  protected void contributeTo_CompilationUnit_problems(LinkedList<Problem> collection) {
    ...
    if (left().type().isString() && right().type().isString()) {
      collection.add(error("String equality testing should be done with .equals()!"));
    }
  }
}
