...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java5/grammar/Generics.ast:78
 * @astdecl GenericMethodDeclSubstituted : GenericMethodDecl ::= Modifiers TypeAccess:Access <ID:String> Parameter:ParameterDeclaration* Exception:Access* [Block] TypeParameter:TypeVariable* <Original:GenericMethodDecl>;
 * @production GenericMethodDeclSubstituted : {@link GenericMethodDecl} ::= <span class="component">&lt;Original:GenericMethodDecl&gt;</span>;

 */
public class GenericMethodDeclSubstituted extends GenericMethodDecl implements Cloneable {
  /**
   * @declaredat ASTNode:1
   */
  public GenericMethodDeclSubstituted() {
    super();
  }
  /**
  ...
  public GenericMethodDeclSubstituted copy() {
    try {
      GenericMethodDeclSubstituted node = (GenericMethodDeclSubstituted) clone();
      node.parent = null;
      if (children != null) {
