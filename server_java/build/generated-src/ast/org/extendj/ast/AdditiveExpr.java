...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:280
 * @astdecl AdditiveExpr : ArithmeticExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public abstract class AdditiveExpr extends ArithmeticExpr implements Cloneable {
   ...
   */
  @Deprecated
  public abstract AdditiveExpr fullCopy();
  /**
   * Create a deep copy of the AST subtree at this node.
   * The copy is dangling, i.e. has no parent.
   * @return dangling copy of the subtree at this node
   ...
   */
  public abstract AdditiveExpr treeCopyNoTransform();
  /**
   * Create a deep copy of the AST subtree at this node.
   ...
   */
  public abstract AdditiveExpr treeCopy();
  /**
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeAnalysis.jrag:347
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/TypeCheck.jrag:221
    {
