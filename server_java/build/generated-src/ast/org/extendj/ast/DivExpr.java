...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:278
 * @astdecl DivExpr : MultiplicativeExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class DivExpr extends MultiplicativeExpr implements Cloneable {
   ...
   */
  public DivExpr treeCopyNoTransform() {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:59
   */
  ...
  public Constant constant() {
    Constant constant_value = type().div(getLeftOperand().constant(), getRightOperand().constant());
...
protected ASTState.Cycle isConstant_cycle = null;
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:363
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
