...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:175
 * @astdecl FloatingPointType : NumericType ::= Modifiers <ID:String> BodyDecl*;
...
public class FloatingPointType extends NumericType implements Cloneable {
  ...
  public FloatingPointType(Modifiers p0, String p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   */
  public FloatingPointType(Modifiers p0, beaver.Symbol p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
