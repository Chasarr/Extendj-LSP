...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:241
 * @astdecl AssignURShiftExpr : AssignShiftExpr ::= Dest:Expr Source:Expr;
...
public class AssignURShiftExpr extends AssignShiftExpr implements Cloneable {
   ...
   */
  public AssignURShiftExpr treeCopyNoTransform() {
   ...
   */
  public AssignURShiftExpr treeCopy() {
    AssignURShiftExpr tree = (AssignURShiftExpr) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:392
   */
