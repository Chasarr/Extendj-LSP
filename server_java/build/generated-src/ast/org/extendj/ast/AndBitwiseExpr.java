...
/**
 * @ast node
 * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/grammar/Java.ast:290
 * @astdecl AndBitwiseExpr : BitwiseExpr ::= LeftOperand:Expr RightOperand:Expr;
...
public class AndBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   */
  public AndBitwiseExpr treeCopyNoTransform() {
   ...
   */
  public AndBitwiseExpr treeCopy() {
    AndBitwiseExpr tree = (AndBitwiseExpr) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
   ...
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/ConstantExpression.jrag:76
   */
  ...
  public Constant constant() {
    Constant constant_value = type().andBitwise(getLeftOperand().constant(), getRightOperand().constant());
    return constant_value;
  }
  /**
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /Users/Jonte/Documents/Appar/2021-compiler-lsp/server_java/extendj/java4/frontend/PrettyPrintUtil.jrag:370
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
